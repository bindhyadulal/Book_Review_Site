...
<form align="center" action="product.php" method="POST">
...
<div style="padding-top:10px;">
   ...
   while($rows = mysqli_fetch_assoc($result)){
    ...
    <td class="ellipsis"  style="width:5%;"><?php echo $rows['id'];?></td>
            ...
            <td style="width:15%;">
            <a href="update.php?edit=<?php echo $rows['id'];?>" class="but">edit</a>

            
            <a href="delete.php?delete=<?php echo $rows['id'];?>" class="but">delete</a>
        </td>
    </tr>
